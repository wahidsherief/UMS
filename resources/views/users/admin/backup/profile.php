                    ...
                    <div class="card">
                      ...
                      " id="AdminInfoForm">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName2" placeholder="Name" value="Teacher Account" disabled>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="change_password">
                                    ...
                                    <form class="form-horizontal" action="{{route('teacherChangePassword')}}" method="POST">
                                        @csrf
                                        <div class="form-group row">
